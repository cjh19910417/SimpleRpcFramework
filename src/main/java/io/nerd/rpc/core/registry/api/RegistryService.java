 ...
 * 
 * @see io.nerd.rpc.core.registry.api.Registry
...
public interface RegistryService {
     ...
     * 
     * @see io.nerd.rpc.core.registry.api.NotifyListener#notify(List)
     * @param url 查询条件，不允许为空，如：consumer://10.20.153.10/com.alibaba.foo.BarService?version=1.0.0&application=kylin
     * @return 已注册信息列表，可能为空，含义同{@link io.nerd.rpc.core.registry.api.NotifyListener#notify(List <URL>)}的参数。
     */
